...
source_file = '/home/matthew/Desktop/GitHub/AI_Papa/AI_Papa/ER_wait_predictor/data.csv'

## Load the source csv 
source_df=pd.read_csv(source_file)

print(source_df.info())
print(source_df.updateTime) 

# %%Defines data type 
source_df['topWait']=source_df['topWait'].astype('category')
source_df['hospName']=source_df['hospName'].astype('category')
source_df['updateTime']=pd.to_datetime(source_df['updateTime'],format='%d/%m/%y %h:%M%p') 
